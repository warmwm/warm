...
class CreateVolumeFromSnapshot(base.Scenario):
    """Create an volume from snapshot"""

    __scenario_type__ = "CreateVolumeFromSnapshot"
    ...
    def run(self, result):
        ...
        volume = op_utils.create_volume_from_snapshot(self.size,
                                                        self.snapshot_id,
                                                        self.name)
