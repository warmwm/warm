...
class CreateVolumeType(base.Scenario):
    """Create an OpenStack volume Define Type"""

    __scenario_type__ = "CreateVolumeType"
    ...
    def __init__(self, scenario_cfg, context_cfg):
        ...
        self.volume_type = self.options.get("volume_type")
    ...
    def run(self, result):
        ...
        volume = op_utils.create_volume1(self.cinder_client, self.volume_name,
                                        self.volume_size, self.volume_type, self.image_id)
